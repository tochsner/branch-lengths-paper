...
(TODO: The following paragraph does not make too much sense.)
...
While we focused on ultrametric trees, the approach can be further extended to non-ultrametric trees. One possibility is to design an additional (invertible) embedding step transforming a non-ultrametric tree into a ultrametric tree, and then use the described transformations on the ultrametric tree.
